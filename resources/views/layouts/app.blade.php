		...
		<aside class="app-sidebar sidebar-scroll ">
			...
			<div class="main-sidebar-body circle-animation ">
				...
				<ul class="side-menu circle">
					...
					<li class="slide">
						<a class="side-menu__item" href="#"><i class="side-menu__icon ti-package"></i><span class="side-menu__label">Billing</span></a>
					</li>

                    <li class="slide">
						<a class="side-menu__item" href="#"><i class="side-menu__icon ti-package"></i><span class="side-menu__label">Account</span></a>
					</li>
					<li class="slide">
						<a class="side-menu__item" href="#"><i class="side-menu__icon ti-package"></i><span class="side-menu__label">Logout</span></a>
					</li>
				</ul>
			</div>
		</aside>
